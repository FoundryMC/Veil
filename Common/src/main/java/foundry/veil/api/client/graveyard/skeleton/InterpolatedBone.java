...
public class InterpolatedBone {
    ...
    public void transform(PoseStack pPoseStack, float partialTick) {
        pPoseStack.translate(Mth.lerp(partialTick, this.pX, this.x), Mth.lerp(partialTick, this.pY, this.y), Mth.lerp(partialTick, this.pZ, this.z));
        ...
        pPoseStack.scale(Mth.lerp(partialTick, this.pXSize, this.xSize), Mth.lerp(partialTick, this.pYSize, this.ySize), Mth.lerp(partialTick, this.pZSize, this.zSize));
    }

    public <T extends InterpolatedSkeleton> void render(Map<String, ModelMesh> meshes, float partialTick, PoseStack poseStack, VertexConsumer pVertexConsumer, int pPackedLight, int pPackedOverlay, float pRed, float pGreen, float pBlue, float pAlpha, boolean drawChildren) {
